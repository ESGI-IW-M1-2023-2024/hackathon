...
final class ArticleFactory extends ModelFactory
{
    ...
    protected function getDefaults(): array
    {
        return [
            ...
            'headerFilename' => self::faker()->image('/var/www/api/public/uploads/articles/headers'),
            'imageFilename' => self::faker()->image('/var/www/api/public/uploads/articles/images'),
            'title' => self::faker()->words(5, true),
            'subtitle' => self::faker()->words(3, true),
        ];
    }
