...
const ListGridComponent = <Row,>({ columns, rows, loading, defaultSort, pagination }: ListGridProps<Row>) => {
  ...
  const { page, limit, totalResults, searchParams, setSearchParams, handlePageChange } = pagination;
  ...
  const getDisplayRange = () => {
    ...
    return (
      <Box sx={{ position: 'absolute', right: 0, mr: 3 }}>
        <Typography color={palette.primary.main} fontWeight='bold' fontSize={14}>
